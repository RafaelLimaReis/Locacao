...
<html>
<head>
    <title>External Drag and Drop (AJAX Event Calendar)</title>
...
<div class="note"><b>Note:</b> External item can be dragged to the event calendar. Read more about <a href="https://doc.daypilot.org/calendar/external-drag-and-drop/">external drag and drop</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    dp.timeRangeTapAndHoldHandling = "ContextMenu";
    ...
    var e = new DayPilot.Event({
        ...
        id: DayPilot.guid(),
        text: "Special event",
        areas: [{"action":"Move","h":17,"w":17,"v":"Visible","css":"event_action_move","top":3,"right":2}]    
    });
    dp.events.add(e);
