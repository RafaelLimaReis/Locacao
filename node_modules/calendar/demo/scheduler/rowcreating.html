...
<div>
  <a href='localization.html'><span>Localization</span></a>
	...
	<!-- /top -->
        ...
        <div class="note"><b>Note: </b> You can add a new resource using the special row at the bottom. Read more about <a href="https://doc.daypilot.org/scheduler/row-creating/">row creating</a> [doc.daypilot.org].</div>
