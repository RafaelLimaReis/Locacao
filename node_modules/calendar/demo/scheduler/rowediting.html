...
<div>
  <a href='localization.html'><span>Localization</span></a>
	...
	<!-- /top -->
        ...
        <div class="note"><b>Note: </b> Edit the row text by clicking on the header. Read more about <a href="https://doc.daypilot.org/scheduler/row-editing/">row editing</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    dp.onRowEdit = function(args) {
        if (args.canceled) {
            window.console && console.log("User-canceled.");
        }
    };
