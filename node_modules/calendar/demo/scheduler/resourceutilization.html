...
<html>
<head>
    <title>Cell Utilization (JavaScript Scheduler)</title>
...
<div class="note"><b>Note:</b> The grid cells display peak resource utilization calculated from a custom "percentage" event field.</div>
