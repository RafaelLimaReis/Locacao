...
<div class="note"><b>Note:</b> This scheduler displays 300 resources, each with 3 children. The row headers are rendered progressively during scrolling (.progressiveRowRendering = true).
Read more about <a href="https://doc.daypilot.org/scheduler/progressive-row-rendering/">progressive row rendering</a>.</div>
