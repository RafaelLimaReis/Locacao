...
<script type="text/javascript">
    ...
    dp.events.list = [];
    for(var x = 0; x < 100; x++) {
        dp.resources.push({name: "Resource " + x, id: x});

        for (var i = 0; i < 100; i++) {
            var e = {
                start: new DayPilot.Date("2016-01-01").addDays(i),
                end: new DayPilot.Date("2016-01-01").addDays(i + 1),
                id: DayPilot.guid(),
                resource: x,
                text: "Event " + (i + 1)
            };
