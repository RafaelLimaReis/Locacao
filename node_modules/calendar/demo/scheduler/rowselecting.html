...
<div class="note"><b>Note: </b> Select a row row by clicking on the header. Select multiple rows using Ctrl + click or Shift + click. Read more about <a href="https://doc.daypilot.org/scheduler/row-selecting/">row selecting</a> [doc.daypilot.org].</div>

<div class="space"><a href="javascript:dp.rows.selection.add(dp.rows.find('B'));">Add "Room B" to selection</a> | <a href="javascript:dp.rows.selection.clear();">Clear selection</a></div>
