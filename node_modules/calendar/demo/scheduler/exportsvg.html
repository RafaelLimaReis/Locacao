...
<div class="note"><b>Note:</b> Read more about <a href="https://doc.daypilot.org/scheduler/client-side-svg-export/">client-side SVG export</a>.</div>
    ...
    */
    ...
    $(document).ready(function() {
        $("#export-button").click(function(ev) {
            ...
            var e = dp.exportAs("svg", {area: area, dateFrom: "2016-01-01", dateTo: "2016-01-31", resourceFrom: "A", resourceTo: "D"});
        ...
        $("#download-button").click(function(ev) {
            ev.preventDefault();
            var area = $("#area").val();
            dp.exportAs("svg", {area: area, dateFrom: "2016-01-01", dateTo: "2016-01-31", resourceFrom: "A", resourceTo: "D"}).download();
        });
