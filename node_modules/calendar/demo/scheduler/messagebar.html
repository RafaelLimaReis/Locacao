...
<html>
<head>
    <title>Message Bar (Scheduler)</title>
...
<div>
  <a href='localization.html'><span>Localization</span></a>
	...
	<!-- /top -->
        ...
        <div class="note"><b>Note:</b> Read more about the <a href="https://doc.daypilot.org/scheduler/message-bar/">message bar</a> [doc.daypilot.org].</div>

        <div class="space">
            Message bar position:
            <a href="javascript:dp.messageBarPosition='Top';dp.message('Message bar moved to the top.');">Top</a> (default)
            |
            <a href="javascript:dp.messageBarPosition='Bottom';dp.message('Message bar moved to the bottom.');">Bottom</a>
        </div>
