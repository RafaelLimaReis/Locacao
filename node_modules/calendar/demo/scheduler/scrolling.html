...
<div class="note">
    Scroll to: <a href="javascript:dp.scrollTo('2015-01-01', animated(), target());">start</a> | <a href="javascript:dp.scrollTo(new DayPilot.Date(), animated(), target());">now</a> | <a href="javascript:dp.scrollTo('2016-01-01', animated(), target());">end</a>
    - options:
    <select id="animated">
