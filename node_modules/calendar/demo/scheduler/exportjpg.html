...
<div class="note"><b>Note:</b> Read more about <a href="https://doc.daypilot.org/scheduler/client-side-jpeg-export/">client-side JPEG export</a>.</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#download-button").click(function(ev) {
            ev.preventDefault();
            var area = $("#area").val();
            dp.exportAs("jpeg", {area: area, dateFrom: "2016-01-01", dateTo: "2016-01-31", resourceFrom: "A", resourceTo: "D"}).download();
        });
    });
