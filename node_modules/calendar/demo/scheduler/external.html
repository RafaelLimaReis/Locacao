...
<html>
<head>
    <title>External Drag and Drop (AJAX Scheduler)</title>
...
<div class="note"><b>Note:</b> Read more about <a href="https://doc.daypilot.org/scheduler/external-drag-and-drop/">external drag and drop</a> [doc.daypilot.org].</div>
        
        <div style="float:left; width: 200px;">
            Drag items from this list to the scheduler:
            <ul id="external">
                <li data-id="123" data-duration="3600"><span style="cursor:move">Item #123 (1 hour)</span></li>
                <li data-id="124" data-duration="7200"><span style="cursor:move">Item #124 (2 hours)</span></li>
            </ul>
            <div class="space">Items with drag handles:</div>
            <div id="handle">
                <div data-id="126" data-duration="3600" data-text="Item 126"><span class="move-handle" style="cursor:move; border: 1px solid #eee;">X</span> Item with a move handle (126)</div>
                <div data-id="127" data-duration="3600" data-text="Item 127"><span class="move-handle" style="cursor:move; border: 1px solid #eee;">X</span> Item with a move handle (127)</div>
            </select>
            </div>
        </div>
    ...
    function makeDraggable() {
        ...
        for (var i = 0; i < items.length; i++) {
            ...
            var item = {
                ...
                barColor: "red",
                barBackColor: "white",
                externalCssClass: "red",
                externalHtml: "Drag me",
        ...
        $("#handle .move-handle").each(function() {
