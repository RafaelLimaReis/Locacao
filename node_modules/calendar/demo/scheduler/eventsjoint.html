...
<div class="note"><b>Note:</b> Joint events can be moved and resized together.</div>

<div class="space">
<label for="move-together"><input type="checkbox" checked="checked" id="move-together" /> Move joint events together</label>
<label for="resize-together"><input type="checkbox" checked="checked" id="resize-together" /> Resize joint events together</label>
</div>
...
<script>
    $(document).ready(function() {
        $("#move-together").change(function() {
            dp.jointEventsMove = $(this).is(":checked");
        });
        $("#resize-together").change(function() {
            dp.jointEventsResize = $(this).is(":checked");
        });
    });
