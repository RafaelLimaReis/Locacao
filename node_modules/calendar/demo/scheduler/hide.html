...
<html>
<head>
    <title>Hide Weekends (Scheduler)</title>
...
<div class="note"><b>Note:</b> Read more about the <a href="https://doc.daypilot.org/scheduler/hiding-non-business-hours/">hiding non-business hours</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    for (var i = 0; i < 10; i++) {
        ...
        var e = new DayPilot.Event({
            start: new DayPilot.Date("2013-03-02T00:00:00").addDays(start),
            end: new DayPilot.Date("2013-03-02T00:00:00").addDays(start).addDays(duration),
            id: DayPilot.guid(),
