...
<div class="note"><b>Note:</b> You can select multiple time ranges while holding Ctrl. Read more about <a href="https://doc.daypilot.org/scheduler/time-range-multi-selecting/">time range multi-selecting</a>.</div>
...
<script type="text/javascript">
    ...
    dp.onTimeRangeSelected = function (args) {
        new DayPilot.Modal({
            onClosed: function() { dp.clearSelection(); }
        }).showUrl("multirangeedit.html");
    };
