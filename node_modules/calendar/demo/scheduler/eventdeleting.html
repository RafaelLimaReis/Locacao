...
<html>
<head>
    <title>Event Deleting (AJAX Scheduler)</title>
...
<div class="note"><b>Note:</b> Read more about <a href="https://doc.daypilot.org/scheduler/event-deleting/">event deleting</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    dp.onEventDelete = function(args) {
        //window.console && console.log("Deleting: " + args.e.id());
    };

    dp.onEventDeleted = function(args) {
        //window.console && console.log("Deleted: " + args.e.id());
    };
