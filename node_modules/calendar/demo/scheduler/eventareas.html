...
<html>
<head>
    <title>Event Active Areas (AJAX Scheduler)</title>
...
<div class="note"><b>Note:</b> Hold a cursor on an event to see the active areas. Read more about <a href="https://doc.daypilot.org/scheduler/event-active-areas/">event active areas</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    for (var i = 0; i < 10; i++) {
        ...
        var e = new DayPilot.Event({
            ...
            areas: [
                {"action":"JavaScript","js":"(function(e) { dp.events.remove(e); })","h":17,"w":17,"v":"Hover","css":"event_action_delete","top":6,"right":2}
            ]
        });
        dp.events.add(e);
    }
