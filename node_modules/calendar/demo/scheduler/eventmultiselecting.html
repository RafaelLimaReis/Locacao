...
<div>
  <a href='localization.html'><span>Localization</span></a>
	...
	<!-- /top -->
                    ...
                    <div class="note"><b>Note:</b> Select multiple events using Shift + mouse drag. Use Ctrl + click to add/remove events from selection.</div>
...
<script type="text/javascript">
    ...
    */
    ...
    dp.onTimeRangeClick = function(args) {
        console.log("onTimeRangeClick");
    };
    ...
    */
    ...
    dp.onRectangleEventSelected = function(args) {
        $("#msg").html("(selection complete)");
    };
    ...
    $(document).ready(function() {
        $("#mode").change(function() {
            var mode = $(this).val();
            dp.multiSelectRectangle = mode;
        });
        $("#shift").change(function() {
            switchShift = $(this).is(":checked");
