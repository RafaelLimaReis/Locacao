...
<div class="note"><b>Note:</b> dp.eventStackingLineHeight is set to 30. This means each line of concurrent events will take 30% of its height.</div>
...
<script type="text/javascript">
    ...
    dp.events.add(new DayPilot.Event({
        start: new DayPilot.Date("2015-03-26T00:00:00"),
        end: new DayPilot.Date("2015-04-01T00:00:00"),
        id: DayPilot.guid(),
        resource: "B",
        text: "First Event"
    }));
    ...
    dp.events.add(new DayPilot.Event({
        start: new DayPilot.Date("2015-03-28T00:00:00"),
        end: new DayPilot.Date("2015-04-02T00:00:00"),
        id: DayPilot.guid(),
        resource: "B",
        text: "Second Event"
    }));
    ...
    dp.events.add(new DayPilot.Event({
        start: new DayPilot.Date("2015-03-30T00:00:00"),
        end: new DayPilot.Date("2015-04-03T00:00:00"),
        id: DayPilot.guid(),
        resource: "B",
        text: "Third Event"
    }));
