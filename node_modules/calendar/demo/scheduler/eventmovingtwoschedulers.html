...
<script type="text/javascript">
    ...
    // view
    dp.startDate = new DayPilot.Date("2015-01-01");  // or just dp.startDate = "2015-03-25";
    dp.days = 365;
    dp.scale = "Day";
    ...
    // view
    dp2.startDate = new DayPilot.Date("2015-01-01");  // or just dp.startDate = "2015-03-25";
    dp2.days = 7;
    dp2.scale = "Hour";
    ...
    function eventMove(target, args) {
        ...
        /*
        if (window.console) {
            console.log("Moving, external: " + args.external);
            console.log(source);
            console.log(target);
        }
        */
