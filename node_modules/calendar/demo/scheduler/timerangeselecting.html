...
<div class="note"><b>Note:</b> This page uses a custom rule for event creating (maximum of 3 days can be selected), implemented using onTimeRangeSelecting event. Read more about the <a href="https://doc.daypilot.org/scheduler/time-range-selecting/">time range selecting</a>.</div>
