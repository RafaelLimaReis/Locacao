...
<div class="note"><b>Note:</b> Read more about <a href="https://doc.daypilot.org/scheduler/client-side-png-export/">client-side PNG export</a>.</div>
    ...
    */
    ...
    $(document).ready(function() {
        $("#export-button").click(function(ev) {
            ev.preventDefault();
            var area = $("#area").val();
            var element = dp.exportAs("png", {area: area, dateFrom: "2016-01-01", dateTo: "2016-01-31", resourceFrom: "A", resourceTo: "D"}).toElement();
            ...
            ctx.font = "bold 16px Tahoma, Arial, Helvetica, sans-serif";
            ctx.fillText("Header", 0, 40);
            ctx.drawImage(element, 0, 50);
        ...
        $("#download-button").click(function(ev) {
            ev.preventDefault();
            var area = $("#area").val();
            dp.exportAs("png", {area: area, dateFrom: "2016-01-01", dateTo: "2016-01-31", resourceFrom: "A", resourceTo: "D"}).download();
        });
    });
