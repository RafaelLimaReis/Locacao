...
<div class="note"><b>Note:</b> You can write custom HTML to grid cells. You can also modify cell properties, such as background color, CSS class and IsBusiness status. Read more about <a href="https://doc.daypilot.org/scheduler/cell-customization/">cell customization</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    dp.onCellMouseOver = function(args) {
        window.console && console.log("over:" + args.cell.x + "-" + args.cell.y);
    ...
    dp.onCellMouseOut = function(args) {
        window.console && console.log("out:" + args.cell.x + "-" + args.cell.y);
    ...
    dp.onTimeHeaderClick = function(args) {
        window.console && console.log(args.header);
