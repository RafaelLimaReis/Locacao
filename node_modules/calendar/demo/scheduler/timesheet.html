...
<html>
<head>
    <title>Timesheet (AJAX Scheduler)</title>
...
<div class="note">
    <b>Note:</b> The <b>timesheet</b> view displays days on the Y axis and 24 hours of day on the X axis. Read more about the <a href="https://doc.daypilot.org/scheduler/timesheet/">timesheet</a> [doc.daypilot.org].
</div>
...
<script type="text/javascript">
    ...
    for (var i = 0; i < 31; i++) {
        ...
        var e = new DayPilot.Event({
            start: new DayPilot.Date("2013-03-01T09:00:00").addDays(i).addHours(start),
            end: new DayPilot.Date("2013-03-01T09:00:00").addDays(i).addHours(start + duration),
            id: DayPilot.guid(),
            text: "Event " + i,
            bubbleHtml: "" + new DayPilot.Date("2013-03-01T09:00:00").addDays(i).addHours(start) + " - " + new DayPilot.Date("2013-03-01T09:00:00").addDays(i).addHours(start + duration)
        });
        dp.events.add(e);
    }
