...
<html>
<head>
    <title>Row Header Columns (AJAX Scheduler)</title>
...
<div class="note"><b>Note:</b> Read more about <a href="https://doc.daypilot.org/scheduler/row-header-columns/">row header columns</a> [doc.daypilot.org].</div>
<div class="note">Toggle "type" column: <a href="#" id="toggle">Toggle</a></div>
...
<script type="text/javascript">
    ...
    dp.resources = [
        { name: "Building A", expanded: true, children: [{ name: "Room 101", id: "101", columns: [{html: "Floor 1"},  {html: "2 beds"}] },
    ...
    var start = new DayPilot.Date("2013-03-02T00:00:00");
    ...
    dp.onBeforeEventRender = function(args) {
        // TODO adjust API: css/cssClass, html/innerHTML, etc.
        args.e.cssClass = "test";
        args.e.innerHTML = args.e.text + ":";
        
        /* available properties: http://api.daypilot.org/daypilot-event-data/ */
    };
    
    
    
    dp.onBeforeCellRender = function(args) {
        // TODO unify the API: css/cssClass, html/innerHTML, etc.
