...
<html>
<head>
    <title>Event Context Menu (AJAX Scheduler)</title>
...
<div class="note"><b>Note:</b> Activate the context menu by right-clicking an event. Read more about the <a href="https://doc.daypilot.org/scheduler/event-context-menu/">event context menu</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    dp.contextMenuSelection = new DayPilot.Menu({items: [
        {text:"Show range", onclick: function() {alert("Event value: " + this.source.start + " " + this.source.end);} },
    ]});
