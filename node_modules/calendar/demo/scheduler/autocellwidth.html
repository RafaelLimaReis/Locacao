...
<div class="note">The cell width is calculated automatically to match the Scheduler width. This option prevents the horizontal scrollbar from appearing. Read more about the <a href="https://doc.daypilot.org/scheduler/auto-cell-width/">auto cell width</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    for (var i = 0; i < 10; i++) {
        ...
        var e = new DayPilot.Event({
            start: new DayPilot.Date("2014-03-25T00:00:00").addHours(start),
            end: new DayPilot.Date("2014-03-25T12:00:00").addHours(start).addHours(duration),
            id: DayPilot.guid(),
            resource: "B",
            text: "Event"/*,
    ...
    dp.contextMenuSelection = new DayPilot.Menu([
        {text:"show", onclick:function() { console.log(this.source)}}
    ]);
