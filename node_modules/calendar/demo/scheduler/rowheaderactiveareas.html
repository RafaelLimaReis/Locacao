  ...
  <a href='localization.html'><span>Localization</span></a>
	        ...
	        <div id="content">
                ...
                <script type="text/javascript">
                    ...
                    dp.onBeforeResHeaderRender = function(args) {
                        args.resource.areas = [
                            {right: 5, top: 5, width: 17, height: 17, v: "Hover", "html":"<div><div><\/div><\/div>", cssClass: "resource_action_menu", action: "ContextMenu", menu: dp.contextMenuResource }
                        ];
                    };
                    ...
                    dp.contextMenuResource = new DayPilot.Menu({
                        items: [
                            {text: "Edit...", action: "JavaScript", onclick: function(ev) { dp.rows.edit(this.source); } },
                            {text: "-"},
                            {text: "Delete...", action: "JavaScript", onclick: function(ev) { dp.rows.remove(this.source); } }
                        ]
                    });
