...
<html>
<head>
    <title>JavaScript Scheduler Cell Stacking Mode</title>
...
<script type="text/javascript">
    ...
    for (var i = 0; i < 5; i++) {
        var e = {
            start: new DayPilot.Date("2015-03-27T00:00:00"),
            end: new DayPilot.Date("2015-03-27T12:00:00"),
            id: DayPilot.guid(),
            resource: "A",
            text: "Event " + (i + 1),
            height: 20 + i*2
    ...
    for (var i = 0; i < 10; i++) {
        var e = {
            ...
            end: new DayPilot.Date("2015-03-28T12:00:00"),
            id: DayPilot.guid(),
            resource: "A",
            text: "Event " + (i + 1),
           // height: 20 + i*3
