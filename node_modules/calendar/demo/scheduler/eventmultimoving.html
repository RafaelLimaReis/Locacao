...
<html>
<head>
    <title>Event MultiMoving (JavaScript Scheduler)</title>
...
<div class="note"><b>Note:</b> You can select multiple events (use Ctrl+click) and move all of them in time at once. Read more about <a href="https://doc.daypilot.org/scheduler/event-multi-moving/">event multimoving</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    dp.multiMoveVerticalMode = "Disabled";  // try "Master" and "All"
    dp.onEventMoved = function(args) {
