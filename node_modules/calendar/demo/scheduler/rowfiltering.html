...
<div class="note"><b>Note:</b> Read more about <a href="https://doc.daypilot.org/scheduler/row-filtering/">row filtering</a>.</div>
...
<script type="text/javascript">
    ...
    dp.resources = [
                 { name: "Room A", id: "A", expanded: true, children:[
                         { name : "Room A.1", id : "A.1", children: [
                             { name : "Room A.1.1", id : "A.1.1" }
                         ]},
                 ...
                 { name: "Room I", id: "I" },
                 { name: "Room J", id: "J" },
                 { name: "Room K (always visible)", id: "K", tags: {alwaysVisible: true} }
                ];
