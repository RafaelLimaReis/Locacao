...
<div class="note"><b>Note:</b> You can select multiple events (use Ctrl+click) and resize all of them in time at once. Read more about <a href="https://doc.daypilot.org/scheduler/event-multi-resizing/">event multi-resizing</a> [doc.daypilot.org].</div>
