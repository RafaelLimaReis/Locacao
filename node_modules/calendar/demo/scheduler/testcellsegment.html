...
<script type="text/javascript">
    ...
    var start = new DayPilot.Date("2015-01-01T12:00:00");
    for (var i = 0; i < 30; i++) {
        dp.timeline.push({
    ...
    */
    ...
    dp.onBeforeCellRender = function(args) {
        var left = args.getPixels(args.cell.start.addHours(3));
        var right = args.getPixels(args.cell.end.addHours(-3));
        var width = right - left;
        args.cell.html = "<div style='position:absolute; background: red; opacity: 0.3; top:0px; bottom:0px; left:" + left + "px;width:" + width + "px';></div>";
    };
    ...
    dp.onEventMoving = function(args) {
        if (args.overlapping) {
            ...
            args.right.html = "snap to the right";
            args.allowed = true;
        }
    };
