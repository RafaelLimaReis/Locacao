...
<html>
<head>
    <title>Time Scale (AJAX Scheduler)</title>
...
<div class="note"><b>Note:</b> Read more about the <a href="https://doc.daypilot.org/scheduler/scale/">scheduler scale</a> [doc.daypilot.org].</div>
...
<script type="text/javascript">
    ...
    for (var i = 0; i < 1; i++) {
        ...
        var e = new DayPilot.Event({
            ...
            end: new DayPilot.Date("2016-03-25T12:00:00").addDays(start).addDays(duration),
            id: DayPilot.guid(),
            resource: "B",
            text: "Event"/*,
...
/*
    dp.onAfterRender = function() {
        var remaining = $(dp.nav.scroll).innerWidth();
        var columns = dp.itline.length;
        var newCellWidth = Math.floor(remaining/columns);
        dp.cellWidth = newCellWidth;
        dp.update();
    };
*/    
    dp.init();
